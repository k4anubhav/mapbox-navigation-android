...
private const val DEFAULT_HEIGHT_FOR_LEGACY = 100
...
fun RouteShield.MapboxLegacyShield.toBitmap(
    ...
    val height = desiredHeight ?: DEFAULT_HEIGHT_FOR_LEGACY
    val stream = ByteArrayInputStream(byteArray)
    return SvgUtil.renderAsBitmapWithHeight(stream, height)
}
