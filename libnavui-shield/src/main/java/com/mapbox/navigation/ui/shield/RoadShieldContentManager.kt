 ...
 */
// TODO: allow for passing custom css styles - cut a ticket to expose customization in the future
// TODO: add test for URL generation in RouteShieldToDownload
// TODO: remove the shield view
// TODO: replace bitmap generation with extension functions on result type for getShields function
// TODO: for designed - one that takes height or defaults to whatever is in the spritesheet
// TODO: for legacy - one that takes the desired height, one that takes context to default to "x" DP
// TODO: separate API for list of road shields
// TODO: deprecate old maneuver shields interface and function
// TODO: verify banner instructions from route progress
internal object RoadShieldContentManager {
    private const val CANCELED_MESSAGE = "canceled"

    private val shieldResultCache = ShieldResultCache()
            ...
            returnList.addAll(
                missingResults.map {
                    ExpectedFactory.createError(
                        RouteShieldError(it.toDownload.generateShieldUrl(), CANCELED_MESSAGE)
                    )
                }
            )
            return returnList
...
private class ShieldRequest(
    ...
    override fun hashCode(): Int {
        var result = toDownload.hashCode()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (toDownload != other.toDownload) return false
